...
public class SpotifyService extends Service implements MediaPlayer.OnPreparedListener {
    ...
    public void playSong(String song) {
        AssetFileDescriptor afd = getApplication().getResources().openRawResourceFd(this.getResources().getIdentifier
                (song, "raw", this.getPackageName()));
        try {
            player.reset();
