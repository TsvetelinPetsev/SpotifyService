...
class RecycleViewAdapter extends RecyclerView.Adapter<RecycleViewAdapter.ViewHolder> {
    ...
    RecycleViewAdapter(ArrayList<SpotifyModel> mAdapterData, OnItemClickListener listener) {
        RecycleViewAdapter.mAdapterData = mAdapterData;
        callback = listener;
    }
    ...
    public void onBindViewHolder(RecycleViewAdapter.ViewHolder holder, int position) {
        if ((holder != null) && (mAdapterData != null) && (mAdapterData.size() > 0)) {
            ...
            displayOrHideButtons(holder.mTextViewExplicit, position % 2 == 0, holder.mButtonDownload.getContext()
                    .getString(R.string.explicit));
            displayOrHideButtons(holder.mButtonDownload, position % 2 == 0, holder.mButtonDownload.getContext()
